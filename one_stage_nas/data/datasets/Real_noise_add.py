...
def load_CRF():
    CRF = sio.loadmat('matdata/201_CRF_data.mat')
    iCRF = sio.loadmat('matdata/dorfCurvesInv.mat')
    B_gl = CRF['B']
    I_gl = CRF['I']
    B_inv_gl = iCRF['invB']
    I_inv_gl = iCRF['invI']
    ...
    if os.path.exists('matdata/201_CRF_iCRF_function.mat')==0:
        ...
        sio.savemat('matdata/201_CRF_iCRF_function.mat', {'CRF':CRF_para, 'iCRF':iCRF_para})
    else:
        Bundle = sio.loadmat('matdata/201_CRF_iCRF_function.mat')
        CRF_para = Bundle['CRF']
