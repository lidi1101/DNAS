...
class DeepLabDecoder(nn.Module):
    ...
    def __init__(self, cfg, out_stride):
        ...
        self.aspp = ASPPModule(inp, 128, rates, use_gap=False)
        self.proj = conv1x1_bn(BxF, 48, 1)
        self.conv0 = sep3x3_bn(176, 128)
        self.conv1 = sep3x3_bn(128, 128)
        self.clf = nn.Conv2d(128, cfg.MODEL.IN_CHANNEL, 1, padding=0)
