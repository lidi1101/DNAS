...
class EmptyH1AutoDeepLab(nn.Module):
    """
    ...
    def __init__(self, cfg):
        super(EmptyH1AutoDeepLab, self).__init__()
        ...
        self.stem = nn.Sequential(
            ...
            conv3x3_bn(64, self.f * self.num_blocks, 2, affine=affine,
                       relu=False))
        self.reduce1 = conv3x3_bn(self.f * self.num_blocks,
                                  self.f, 1, affine=affine,
                                  relu=False)
